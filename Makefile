...
override PACKAGE_NAME=pge4nettalk_client_lazarus
override PACKAGE_VERSION=1.0.0
ifeq ($(FULL_TARGET),i386-linux)
override TARGET_PROGRAMS+=pge4nettalk_client_lazarus
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=../../00_common/ozapi_pascal fundamentals/Utils lazrichview
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=../../00_common/ozapi_pascal fundamentals/Utils lazrichview
endif
